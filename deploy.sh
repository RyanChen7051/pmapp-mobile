...
./node_modules/esbuild/bin/esbuild src/app.js --bundle --outfile=bundle.js --format=iife --target=es2020 --minify --banner:js="/* PMApp Mobile v3.11.0 — Bundled by esbuild */"
