...
const ASSETS = ['./', './index.html', './bundle.js', './manifest.json', './pmapp-watermark.png', './logo-mark-white.png', './logo-lockup-white.png', './icon-192-v2.png', './icon-512-v2.png', './apple-touch-icon-v2.png', './favicon-32-v2.png'];
