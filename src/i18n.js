...
const I18N = {
  ...
  en: {
    ...
    ai_greeting: 'Hello, feel free to ask me anything.', ai_input_ph: 'Type your question…',
  ...
  es: {
    ...
    ai_greeting: 'Hola, pregúntame lo que necesites.', ai_input_ph: 'Escribe tu pregunta…',
  ...
  ja: {
    ...
    ai_greeting: 'こんにちは、何でもお聞きください。', ai_input_ph: '質問を入力…',
  ...
  fr: {
    ...
    ai_greeting: 'Bonjour, posez-moi vos questions.', ai_input_ph: 'Saisissez votre question…',
  ...
  de: {
    ...
    ai_greeting: 'Hallo, stellen Sie mir Ihre Fragen.', ai_input_ph: 'Frage eingeben…',
  ...
  ar: {
    ...
    ai_greeting: 'مرحبًا، يمكنك سؤالي عن أي شيء.', ai_input_ph: 'اكتب سؤالك…',
