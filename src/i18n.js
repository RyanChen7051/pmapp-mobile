...
const I18N = {
  zh: {
    // Tabs
    tab_home: '首页', tab_planning: '计划', tab_factory: '工厂', tab_engineering: '工程', tab_factory_process: '工厂制程', tab_materials: '物料', tab_production: '生产',
    tab_quality: '品质', tab_inspection: 'DOA/RMA', tab_reports: '周/月报', tab_settings: '设定', qual_mod_issues: '问题', qual_mod_inspection: '客验',
    // Home
  ...
  en: {
    tab_home: 'Home', tab_planning: 'Planning', tab_factory: 'Factory', tab_engineering: 'Engineering', tab_factory_process: 'Factory Process', tab_materials: 'Materials', tab_production: 'Production',
  ...
  es: {
    tab_home: 'Inicio', tab_planning: 'Planificacion', tab_factory: 'Fabrica', tab_engineering: 'Ingeniería', tab_factory_process: 'Proceso de fábrica', tab_materials: 'Materiales', tab_production: 'Produccion',
  ...
  ja: {
    tab_home: 'ホーム', tab_planning: '計画', tab_factory: '工場', tab_engineering: 'エンジニアリング', tab_factory_process: '工場プロセス', tab_materials: '資材', tab_production: '生産',
  ...
  fr: {
    tab_home: 'Accueil', tab_planning: 'Planification', tab_factory: 'Usine', tab_engineering: 'Ingénierie', tab_factory_process: 'Processus usine', tab_materials: 'Materiaux', tab_production: 'Production',
  ...
  de: {
    tab_home: 'Start', tab_planning: 'Planung', tab_factory: 'Fabrik', tab_engineering: 'Engineering', tab_factory_process: 'Werksprozess', tab_materials: 'Material', tab_production: 'Produktion',
  ...
  ar: {
    tab_home: 'الرئيسية', tab_planning: 'التخطيط', tab_factory: 'مصنع', tab_engineering: 'هندسة', tab_factory_process: 'عملية المصنع', tab_materials: 'المواد', tab_production: 'الإنتاج',
  ...
  vi: {
    tab_home: 'Trang chủ', tab_planning: 'Kế hoạch', tab_factory: 'Thông tin nhà máy', tab_engineering: 'Kỹ thuật', tab_factory_process: 'Quy trình nhà máy', tab_materials: 'Vật liệu', tab_production: 'Sản xuất',
  ...
  hi: {
    tab_home: 'होम', tab_planning: 'योजना', tab_factory: 'फ़ैक्टरी जानकारी', tab_engineering: 'इंजीनियरिंग', tab_factory_process: 'फ़ैक्टरी प्रक्रिया', tab_materials: 'सामग्री', tab_production: 'उत्पादन',
